...
<template>
  <aside v-if="folderStore.selectedFile.value"
    ...
    <div
      ...
      <h2 class="text-sm font-semibold text-neutral-800 uppercase tracking-wide dark:text-neutral-400">File Details</h2>
      <button
    ...
    <div class="flex-1 overflow-y-auto">
      <FileDetail :file="folderStore.selectedFile.value" />
    </div>
  </aside>
</template>
